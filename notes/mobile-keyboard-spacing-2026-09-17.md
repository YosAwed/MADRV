...
Follow-up source `ef4dfd5` was merged/pushed to main and deployed as production version `82a5c7bf-dcce-4e8d-8308-d42ab4f4d600`. Production asset bytes matched the local build, and all 56 Chromium layout cases plus mute/solo toggles passed at the public production URL with no page errors. Staging still has the previous layout release.
